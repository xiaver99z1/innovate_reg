...
<head>
  ...
  <title>Innovate MGKT Application - Register</title>
...
<div class="register-box">
  <div class="register-logo">
       <a href="register"><b>Innovate MKTG</b><BR>Admin Application</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Register a new membership</p>

   <?php echo form_open(base_url( 'register' ), array( 'id' => 'register', 'class' => 'register' ));?>
      <div class="form-group has-feedback">
		...
		<div style='color:#c7254e'><?php echo form_error('fullname'); ?></div>
      </div>
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Email" name='email' value='<?php echo set_value('email'); ?>'>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
		<div style='color:#c7254e'><?php echo form_error('email'); ?></div>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" name='password' >
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
		<div style='color:#c7254e'><?php echo form_error('password'); ?></div>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Retype password" name='passconf'>
        <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
		<div style='color:#c7254e'><?php echo form_error('passconf'); ?></div>
      </div>
      <div class="row">
        <div class="col-xs-8">
